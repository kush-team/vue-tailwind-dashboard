<template>
  ...
  >
    ...
    >
      <!-- Toggler -->
      <button
        class="cursor-pointer text-black opacity-50 md:hidden px-3 py-1 text-2xl leading-none bg-transparent rounded border border-solid border-transparent"
        type="button"
      ...
      >
        <img
          ...
          src="../assets/img/horizontal-logo-black.png"
        />
      </a>
      <!-- User -->
